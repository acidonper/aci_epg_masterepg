...
- Asier Cidon (@acidonper) -> Small modification to permit masterepg asignation
version_added: '2.4'
options:
  tenant:
    description:
...
def main():
    ...
    argument_spec.update(
        ...
        masterepg=dict(type='str', aliases=['masterepg_name', 'mastername']),  # Not required for querying all objects
    ...
    masterepg = module.params['masterepg']
    bd = module.params['bd']
    ...
    aci.construct_url(
        ...
        child_classes=['fvRsBd','fvRsSecInherited'],
    )
    ...
    if state == 'present':
        aci.payload(
            ...
            child_configs=[
                ...
                dict(fvRsSecInherited=dict(attributes=dict(tDn=masterepg))),
            ],
        )
